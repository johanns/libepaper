...
2. **Export**: Save to BMP with one line
3. **Review**: Open BMP on your computer
...
for (int i = 0; i < 5; ++i) {
    ...
    display.save_framebuffer_to_bmp("layout_" + std::to_string(i) + ".bmp");
}

// Review all BMPs, pick the best one
...
The BMP export maps e-paper colors to RGB:
...
- [API Documentation](../../docs/API.md#debugging--troubleshooting) - Complete BMP export documentation
